...
- **Page shell**: Main content uses horizontal padding `px-4 sm:px-6 lg:px-10` and vertical `py-6 lg:py-8` (see `AppLayout`). Max width `--splm-page-max` (1200px) for standard pages; search stays narrower.
